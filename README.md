...
[![shipthatcode — Build Consistent Hashing](https://api.shipthatcode.com/cert/fd23dcd1c08dea3b2665879b85c26bc2.svg)](https://shipthatcode.com/courses/build-consistent-hashing)

My working repo for [Build Consistent Hashing](https://shipthatcode.com/courses/build-consistent-hashing) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start Build Consistent Hashing"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/build-consistent-hashing) ("Work in your own editor" → **Link repo**). Done — you never do this again.
